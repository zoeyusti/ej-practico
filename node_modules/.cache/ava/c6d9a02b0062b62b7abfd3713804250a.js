...
(0, _ava2.default)('prueba agregar', async t => {
	...
	var usuarios3 = await service.agregarUsuarios(otroUsuario);
	var usuarios4 = fs.appendFile('datosEj.txt', JSON.stringify(otroUsuario) + '\n', function (err) {
		if (err) {
			console.log(err);
		}
	});
	t.deepEqual(usuarios3, usuarios4);
	console.log("agregar");
...
*/
//# sourceMappingURL=/home/zoe/Escritorio/ej-practico/node_modules/.cache/ava/c6d9a02b0062b62b7abfd3713804250a.js.map